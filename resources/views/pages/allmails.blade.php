...
.avatar { width: 32px; height: 32px; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; font-size: 0.7rem; font-weight: 700; color: #fff; margin-right: 8px; flex-shrink: 0; }
...
.av-red { background: #e05c5c; } .av-indigo { background: #5c6bc0; } .av-cyan { background: #26a69a; } .av-amber { background: #f59e0b; }
...
.date-text { 
    ...
    font-size: 0.82rem; 
    white-space: nowrap; }
.amount-text { font-weight: 700; color: #1a1a1a; white-space: nowrap; }
.trend-line { width: 60px; height: 28px; }
...
<div class="orders-wrapper">
    <h1 class="fw-bold fs-6 text-center ">All Mails</h1>
